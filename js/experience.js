...
const exp = [

  {
    ...
    time: "(Jan - Feb, 2024)",
    desp: "<ul><li>Assigning specific roles to team members based on their expertise.</li><li>Organizing regular team meetings to discuss progress, challenges, and updates for the events.</li><li>Maintaining proper code of conduct among the volunteers and the participants.</li></ul>" 
  },
];
